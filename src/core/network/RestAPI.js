...
const Heroku_URL = Constants.Configs.Heroku_URL
...
export async function GetGroupSessions(groupId) {
  return await getRequest(Heroku_URL + '/groups/' + groupId + '/sessions' )
}
...
// export async function AddUserToCurrentSessions()

export async function Login(email = null) {
